...
const NotepadsViewer = ({
  isOpen,
  onClose,
  notepads, // Received from App
  onRefresh, // Callback to refresh App state
  onOpenNotepad,
  onCreateNotepad,
  db,
  activeNotepadId,
  ...
  const onImport = () => {
    notepadActions.importSingleNotepad({
      ...
      onOpenNotepad,
      onClose: () => {
        onRefresh(); // Refresh list after import
        onClose();
      },
      uploadLocalFile,
      base64ToBlob,
      ...
      actions: [
        {
          ...
          action: async () => {
            ...
            // We must fetch the updated list to determine next steps
            // Can't rely on 'notepads' prop immediately as it's stale until refresh
            ...
            if (notepadId === activeNotepadId) {
              if (updatedList.length === 0) {
                ...
                // Since we are deleting, the index might shift, but 'index' var holds the old position
                const nextNotepad =
                  updatedList[index] ||
                  updatedList[index - 1] ||
                  updatedList[0];
              ...
              >
                ...
                <div className="viewer-controls">
                  <div className="viewer-control-container">
                    <button
                      className="viewer-control hovering-label viewer-share-control"
                  ...
                  <div className="viewer-control-container">
                    <button
                      className="viewer-control hovering-label viewer-duplicate-control"
                  ...
                  <div className="viewer-control-container">
                    <button
                      className="viewer-control hovering-label viewer-delete-control"
