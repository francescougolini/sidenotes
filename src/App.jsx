      ...
      actions: [
        {
          ...
          action: async () => {
            ...
            await refreshNotepadsList(); // Sync state
    ...
    <div id="notepad-entry-point" className="entry-point">
      ...
      <div className="toolbox">
        ...
        <div className="toolbox-element">
          <button
            className="toolbox-control hovering-label add-note"
            aria-label="Add note"
            onClick={addNote}
          >
            <AddNoteIcon />
        ...
        <div className="toolbox-element">
          <button
            className="toolbox-control hovering-label notepads-viewer-control"
            aria-label="Notepads"
        ...
        <div className="toolbox-element">
          <button
            className="toolbox-control hovering-label"
        ...
        <div className="toolbox-element">
          <button
            className="toolbox-control hovering-label about"
            aria-label="About"
